class Map::PageController < ParagraphController 
  ...
  class MapViewOptions < HashModel
    attributes :width => 400, :height => 400, :display_type => 'connection', :show_map_types => 'yes',:show_zoom => 'full', :default_icon => nil, :default_zoom => nil, :content_model_id => nil,:content_model_field_id => nil, :content_model_response_field_id => nil, :detail_page_id => nil, :shadow_icon => nil, :icon_anchor_x => 0, :icon_anchor_y => 0, :info_anchor_x => 0,:info_anchor_y => 0,:show_all_locations => false
